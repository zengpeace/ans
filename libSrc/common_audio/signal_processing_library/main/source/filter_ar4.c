                        ...
                        int filtered_low_length)
{
    ...
    {
        WebRtcSpl_CopyFromEndW16_2(filtered, x_length, a_length - 1, state, state_length);
        WebRtcSpl_CopyFromEndW16_2(filtered_low, x_length, a_length - 1, state_low, state_length);
    } else
    {
